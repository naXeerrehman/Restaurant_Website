...
import OrderingWebsiteIcon from "../models/OrderingWebsiteIcon.js";
...
const createIcon = async (req, res) => {
  try {
    ...
    const newIcon = new OrderingWebsiteIcon({
      link,
...
const editIcon = async (req, res) => {
  try {
    ...
    const updatedIcon = await OrderingWebsiteIcon.findByIdAndUpdate(
      id,
      updatedData,
      { new: true }
    );
...
const getIcons = async (req, res) => {
  try {
    const icons = await OrderingWebsiteIcon.find(); // Fetch all icons
...
const deleteIcon = async (req, res) => {
  try {
    ...
    const deletedIcon = await OrderingWebsiteIcon.findByIdAndDelete(id);
